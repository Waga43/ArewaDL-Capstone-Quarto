...
groups (\citeproc{ref-ebby_traditional_2024}{Ebby 2024};
\citeproc{ref-Ministry_of_Information_Culture_and_Tourism_2025}{Ministry
of Information, Culture and Tourism n.d.}) . The three major ethnic
...
Two CNN architectures were employed (\citeproc{ref-he_deep_2016}{He et
al. 2016}; \citeproc{ref-tan_efficientnet:_2019}{Tan and Le 2019}):

\begin{itemize}
\item
  \textbf{ResNet34}: A 34-layer residual network known for its ability
  to mitigate vanishing gradient issues
  (\citeproc{ref-alshagathrh_efficient_2023}{Alshagathrh et al. 2023};
  \citeproc{ref-kansal_resnet-50_2024}{Kansal, Chandra, and Singh 2024};
  \citeproc{ref-pamungkas_leaf_2023}{Pamungkas et al. 2023};
  \citeproc{ref-shams_skin_2025}{Shams et al. 2025}).
\item
...
Alshagathrh, Fahad M., Saleh Musleh, Mahmood Alzubaidi, Jens Schneider,
and Mowafa S. Househ. 2023. {``Efficient {Detection} of {Hepatic}
{Steatosis} in {Ultrasound} {Images} {Using} {Convolutional} {Neural}
{Networks}: {A} {Comparative} {Study},''} October.
\url{https://doi.org/10.18280/ts.400501}.
...
Kansal, Kajal, Tej Bahadur Chandra, and Akansha Singh. 2024.
{``{ResNet}-50 Vs. {EfficientNet}-{B0}: {Multi}-{Centric}
{Classification} of {Various} {Lung} {Abnormalities} {Using} {Deep}
{Learning}.''} \emph{Procedia Computer Science}, International
{Conference} on {Machine} {Learning} and {Data} {Engineering} ({ICMLDE}
2023), 235 (January): 70--80.
\url{https://doi.org/10.1016/j.procs.2024.04.007}.

\bibitem[\citeproctext]{ref-Ministry_of_Information_Culture_and_Tourism_2025}
Ministry of Information, Culture and Tourism. n.d. {``Culture -- {MFA}
{Press} {Center}.''} Accessed May 31, 2025.
\url{https://foreignaffairs.gov.ng/nigeria/nigeria-culture/}.

\bibitem[\citeproctext]{ref-pamungkas_leaf_2023}
Pamungkas, Wisnu Gilang, Machammad Iqbal Putra Wardhana, Zamah Sari, and
Yufiz Azhar. 2023. {``Leaf {Image} {Identification}: {CNN} with
{EfficientNet}-{B0} and {ResNet}-50 {Used} to {Classified} {Corn}
{Disease}.''} \emph{Jurnal RESTI (Rekayasa Sistem Dan Teknologi
Informasi)} 7 (2): 326--33.
\url{https://doi.org/10.29207/resti.v7i2.4736}.

\bibitem[\citeproctext]{ref-shams_skin_2025}
Shams, Mahmoud Y., Esraa Hassan, Sara Gamil, Aya Ibrahim, Esraa Gabr,
Sarah Gamal, Esraa Ibrahim, et al. 2025. {``Skin {Disease}
{Classification}: {A} {Comparison} of {ResNet50}, {MobileNet}, and
{Efficient}-{B0}.''} \emph{Journal of Current Multidisciplinary
Research} 1 (1): 1--7.
\url{https://doi.org/10.21608/jcmr.2025.327880.1002}.
